...
Phase S3.2: Ledger Viewer / Editor Screen（ISSUE-0013）。
...
（+ session/player repository）のみに依存する（CLAUDE.md § Ledger / Points / Settlement、ADR-0011）。

できること（S3.2 scope, ISSUE-0013）:
