# ADR-0011: Ledger / points / settlement design direction (S3)
...
9. **契約は本 phase では markdown draft**（`ledger-overview.md` / `ledger-schema.md` 擬似 schema）。
   ...
   **S3.1（ISSUE-0012）** で追加し、その時点で freeze 手続きに入る。
...
- `docs/issues/0001-point-balance-source-of-truth.md`,
  `docs/issues/0012-ledger-core-implementation.md`,
  `docs/issues/0013-ledger-desktop-viewer.md`, `docs/issues/0014-settlement-export.md`
