...
- `docs/issues/0005-parallel-dev-contract-drift.md` — 新規 issue（Open）。並行開発の
  contract drift / 凍結タイミングの blocking risk。
- `docs/decision-log.md` — ADR-0004 と ISSUE-0005 を index に追加。
...
- 各 phase の blocker（特に ISSUE-0003 が S3 の gate、ISSUE-0005 が全体の drift risk）が
  追跡可能。
...
- ISSUE-0005 で contract drift / 凍結タイミング / mock 乖離 / ISSUE-0003 依存を risk 登録。
...
- [ ] ISSUE-0003（point 残高 source of truth）の決着（S3 の gate）。
...
- `docs/issues/0005-parallel-dev-contract-drift.md`
- `docs/issues/0003-point-balance-source-of-truth.md`（S3 の直接 blocker）
