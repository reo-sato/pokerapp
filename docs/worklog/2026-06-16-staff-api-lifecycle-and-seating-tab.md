# Worklog: staff API §A/§B 実装 + staff アプリ座席タブ（WS4, ADR-0038）
...
ADR-0038 §A（会計の reversal / point grant）と §B（session / 座席 / player ライフサイクル）の
...
- `docs/adr/0038-staff-api-session-seat-handlogger-expansion.md`（§A/§B 実装）
- `docs/adr/0037-staff-ipad-app-touch-frontend.md`（staff アプリ）
