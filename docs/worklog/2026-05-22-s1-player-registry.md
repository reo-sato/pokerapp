...
- `docs/issues/0002-display-name-uniqueness-scope.md` — 新規。uniqueness 仕様の将来拡張を
  open question として登録。
- `docs/decision-log.md` — Major Issue Index に ISSUE-0002 を追加。
...
- `docs/issues/0002-display-name-uniqueness-scope.md`
