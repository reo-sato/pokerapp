# Issue 0013: Session / Seating Viewer の data source 依存と将来拡張が未確定

> **採番替え**: 元は ISSUE-0008 として起票されたが、verify-v1 統合時に
> `0008-pokerkit-online-feeding-feasibility.md` と ID が衝突したため **0013** に採番替えした。
