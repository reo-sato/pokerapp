...
**version: 1.9 (ADR-0058 追記 4。1.0 frozen 起点、以降は additive)** ／ canonical RFID transport（ADR-0015）の
...
**v1.9 の変更点（読み落ちたことのある札は差し直しの対象にしない・戻った札で差し替えを取り消す）** は §10 を参照。v1.2 は「slot ごとに reader 名を分ける」規約を
