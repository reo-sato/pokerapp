...
| ISSUE-0006 | Hand 開始時の seat→player_id 選択 UX が未確定        | Open   | 2026-06-03 | hand logger × session / GUI | `docs/issues/0006-seat-selection-ux-at-hand-start.md`      | Phase 2.2 は暫定（seating 空）で迂回。UI 本体は Phase 2.3 で確定 |
