...
| ISSUE-0006 | Hand 開始時の seat→player_id 選択 UX が未確定        | Fixed  | 2026-06-03 | hand logger × session / GUI | `docs/issues/0006-seat-selection-ux-at-hand-start.md`      | M3 (= E3, 2026-06-11): prompt 選択 + dashboard「席設定」+ `seat_assign` queue イベント（次ハンド反映） |
