...
| ADR-0006 | RFID hardware migration to PN5180 + ESP32-S3 (HTTP transport contract unchanged)   | Accepted | 2026-06-01 | rfid / hardware boundary      | `docs/adr/0006-rfid-hardware-migration-pn5180-esp32s3.md`                                         | 関連: ADR-0007             |
| ADR-0007 | USB-CDC serial as primary RFID transport (ESP32-S3 USB direct connection)          | Accepted | 2026-06-01 | rfid / transport              | `docs/adr/0007-rfid-usb-cdc-serial-transport.md`                                                  | ADR-0006 Alt.B を採用      |
...
| ISSUE-0007 | PN5180+ESP32-S3 移行の未確定事項（タグ規格 / USB-CDC transport） | Partially Resolved | 2026-06-01 | rfid / hardware boundary   | `docs/issues/0007-rfid-pn5180-esp32s3-open-questions.md`      | USB-CDC: ADR-0007     |
