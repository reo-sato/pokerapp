/**
 * Staff App (ADR-0035): 店舗（スタッフ）専用タッチ front-end。player 用 `mobile/` とは別アプリ。
 *
 * repository は StaffRepository interface 越しに注入する (contract-first, ADR-0035 §6):
 ...
 * 座席 / ハンドロガー遠隔制御タブは ADR-0036 の staff API 追加後に additive で足す。
 */
